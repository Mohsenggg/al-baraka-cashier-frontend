...
export class ReceiptService {
      ...
      public filterReceipts(params: ReceiptFilterParams): void {
            ...
            // Endpoint: /api/receipt/filter (environment.apiUrl is /api)
            this.http.get<PageResponseDto<ReceiptListItemDto>>(`${environment.apiUrl}/receipt/filter`, { params: httpParams }).subscribe({
                  next: (res) => {
